...
try:
    ...
    print("WARNING: Matplotlib could not be imported.")
    plt = None
...
def printensor2file(tensor, plotfun=None, savedir=None, channels=None, batches=None, interpolation='none',
    ...
    if plt is not None and plotfun is None:
        plotfun = plt.imshow

    # Allow tensor to be an image
    if tensor.ndim == 2:
